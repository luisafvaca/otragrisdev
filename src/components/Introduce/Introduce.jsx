...
const Introduce = () => { 
    return (
        <div>
            <p><span className='helloText'>Hello humans! <span role='img' aria-label='marcian'>👽</span></span> I'm Lu and I'm front-end developer base on Medellín, Colombia <span role='img' aria-label='flag'>🇨🇴</span></p>
